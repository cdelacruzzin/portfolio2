  ...
  <div className='d-flex justify-content-center flex-column'>
    ...
    <div className='rounded-xl p-5 form-container d-flex justify-content-center'>
      ...
      <form className='d-flex flex-column p-5 gap-5' id='contact-form'>
        ...
        <label>Name <span className='required-span'></span></label>
        <input
          value={name}
          name='name'
          onChange={handleInputChange}
        ...
        <label>Email <span className='required-span'></span></label>
        <input
          value={email}
          name='email'
          type='email'
        ...
        <label>Inquiry <span className='required-span'></span></label>
        <textarea
          value={inquiry}
          name='inquiry'
          type='inquiry'
